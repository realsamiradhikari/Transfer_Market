...
public class CustomQueue {
    ...
    private LinkedList<TransferModel> vivaList; // Internal storage for the queue.
     ...
     *
     * @return the first TransferModel in the queue, or null if the queue is
 empty.
     * @throws IllegalStateException if the queue is empty.
     */
    public TransferModel deQueue() {
        try {
     ...
     *
     * @param studentModel the TransferModel to be added to the queue.
     * @return the current size of the queue after the operation , or -1 if the
     * queue is full.
     */
    public int enQueue(TransferModel studentModel) {
        if (isFull()) {
